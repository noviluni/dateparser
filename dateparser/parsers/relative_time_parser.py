...
from dateparser.parsers import _get_translated_date, _time_parser_obj
from dateparser.timezone_parser import pop_tz_offset_from_string
from dateparser.utils import strip_braces, localize_timezone, apply_timezone
...
class _RelativeTimeParser:
    ...
    def _parse_time(self, date_string, settings):
        ...
        try:
            return _time_parser_obj(date_string)
        except:
            pass
...
_relative_time_parser = _RelativeTimeParser()
